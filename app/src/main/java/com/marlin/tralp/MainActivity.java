...
import com.marlin.tralp.MenuViews.AdicionarGesto;
import com.marlin.tralp.MenuViews.Configuracoes;
import com.marlin.tralp.MenuViews.Contato;
import com.marlin.tralp.MenuViews.Dicas;
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            ...
            case 3:
                ...
                break;
            case 4:
                mTitle = getString(R.string.contato) ;
                break;
            case 5:
                mTitle = getString(R.string.tutorial) ;
                break;
            case 6:
                mTitle = getString(R.string.dicas) ;
                break;
            case 7:
